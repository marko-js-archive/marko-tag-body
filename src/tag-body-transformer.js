...
module.exports = function transform(el, context) {
    ...
    if (bodyExpressionAttr != null) {
        ...
        el.appendChild(builder.node(function(node, codegen) {
            var builder = codegen.builder;
            var helperModulePath = builder.literal(codegen.getRequirePath(resolvedHelperModulePath));
            var tagBodyHelperVar = codegen.context.addStaticVar('__tagBody', builder.require(helperModulePath));
